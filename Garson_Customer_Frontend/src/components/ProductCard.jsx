...
function ProductCard({ product, onAdd }) {
  ...
  return (
    <article className="group w-full min-w-0 overflow-hidden rounded-xl border border-cyan-200/20 bg-slate-900/80 shadow-[0_8px_18px_rgba(2,12,27,0.35)] sm:rounded-3xl sm:shadow-[0_15px_45px_rgba(2,12,27,0.55)]">
