...
function ProductCard({ product, onAdd }) {
  ...
  return (
    <article className="group w-full min-w-0 overflow-hidden rounded-xl border border-cyan-200/20 bg-slate-900/80 shadow-[0_8px_18px_rgba(2,12,27,0.35)] [content-visibility:auto] sm:rounded-3xl sm:shadow-[0_15px_45px_rgba(2,12,27,0.55)]">
      ...
      <div className="min-w-0 space-y-1.5 p-2.5 sm:space-y-3 sm:p-4">
        <h3 className="overflow-hidden text-[13px] font-bold tracking-wide text-slate-100 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:1] [overflow-wrap:anywhere] sm:text-lg sm:[-webkit-line-clamp:2]">
          {product.name}
        </h3>
